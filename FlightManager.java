...
public class FlightManager
{
	...
	*/
    ...
    /*
		...
		Input:				Input that needs to be validated, num corresponds to which type to validate 
		
		proccessing:		Validates userInput
        
		Output:				True or false depending on state of validation
	*/
	...
	/*
		...
		Proccessing:		Decides which method to enter depending on what code the user inputed
	...
	*/
	...
	public static void editFlight(String flightNum,String flightDays,String startDateFlight,String endDateFlight)
	{
		...
		else
		{
			...
			if(flightToEdit)
			{
				if(validateFlight(flightDays,3) && validateFlight(startDateFlight,4) && validateFlight(endDateFlight,4))		isValid = true;
